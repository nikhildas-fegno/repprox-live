...
export const metadata: Metadata = buildMetadata({
  title: "Industries",
  description:
    "RepProX is configured for the realities of wholesale distribution, manufacturing, retail & e-commerce, and professional services — not retrofitted generic templates.",
  path: "/industries",
});
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden border-b border-ink/10 bg-paper">
        ...
        <Container className="relative pt-20 pb-16 lg:pt-28 lg:pb-20">
          <SectionHeading
            ...
            description="A distributor's reorder logic isn't a manufacturer's bill of materials, and a retailer's promotions aren't a services firm's project budgets. RepProX ships with the workflows, reports, and data structures each industry actually needs."
          />
        </Container>
      </section>

      <section aria-label="Industries served by RepProX" className="bg-paper">
      ...
      <CtaSection
        ...
        title="RepProX is configurable well beyond these four industries."
